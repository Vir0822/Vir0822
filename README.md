...
- Security-first: minimize trusted surfaces, apply least-privilege, and write defensive code.  
- Test-driven: unit, property-based and fuzz testing using Foundry.  
- Audit-aware: clear interfaces, thorough documentation, and the use of vetted libraries (OpenZeppelin).  
...
- Contract testing, property-based testing & fuzzing (Foundry)  
...
- Implement & review Solidity smart contracts (ERC standards, tokens, access control, upgradeable contracts).  
- Design and run comprehensive test suites (unit, property-based & fuzz tests) with Foundry.  
